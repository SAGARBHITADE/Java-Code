...
public class ScrenShot11 {
	...
	public void takescrenshot() throws  IOException {
		...
		TakesScreenshot tsss = (TakesScreenshot) ref;

		File sorce = tsss.getScreenshotAs(OutputType.FILE);

		File f2 = new File(System.getProperty("user.dir") + "\\ScrenShotP\\s4.png");

		FileHandler.copy(sorce, f2);
		ref.close();
