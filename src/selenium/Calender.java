	...
	public static void SelectDate(String Month1,int Date1) {
		...
		ref.manage().window().maximize();
		 ...
		 while(true) {
		   ...
		   if (!Stext.equalsIgnoreCase(Month1)) {
			   
			   //ref.findElement(By.xpath("//*[@id='ui-datepicker-div']//div//a[@title='Prev']")).click();
			   WebElement prevButton=ref.findElement(By.xpath("//*[@id='ui-datepicker-div']//div//a[@title='Prev']"));
				prevButton.click();
		   }
		   else {
			break;
		 ...
		 ref.findElement(By.xpath("//*[@id='ui-datepicker-div']//table//tbody//tr//td//a[text()='"+Date1+"']")).click();
